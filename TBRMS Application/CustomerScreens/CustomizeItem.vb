Public Class CustomizeItem
    ...
    Function GetItemNames(dtbInvIDs As DataTable, ByRef strItemNames() As String)
        ...
        'Query the Inventory table for the name of each ingredient in the selected item
        For i As Integer = 0 To dtbInvIDs.Rows.Count - 1
            ...
            'Fill the dtbItemNames datatable
            Using connection
                connection.Open()
        ...
        'Set each Ingredient panel's name label equal to the correct Ingredient
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        'Queries the Inventory table for the Mod Code of each ingredient for the selected item
        For i As Integer = 0 To intIngCount - 1
            ...
            'Fills the dtb temporary DataTable
            Using connection
                connection.Open()
                Using dad As New SqlClient.SqlDataAdapter(strSelect, connection)
                    dad.Fill(dtb)
        ...
        'Fills the strMods string with the amount and Mod Code of each ingredient 
        ...
        'Adds a row in the dtbOrderMods DataTable with each Ingredient amount if the item is a newly selected one
        If CustomerOrderDashboard.intSelectedIndex = -1 Then
        ...
        Else
            'Changes the amount of each ingredient in the dtbOrderMods DataTable if the item is being edited
            Select Case intIngCount
                Case 1
        ...
        'Adds the new item to the dgvOrderSummary DataGridView along with its mods
        If (CustomerOrderDashboard.intSelectedIndex = -1) Then
        ...
        Else
            'Updates the item in the dgvOrderSummary DataGridView along with its mods
    ...
    'Modify Ingredient amount button functions

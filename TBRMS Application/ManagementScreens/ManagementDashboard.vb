Public Class ManagementDashboard
    ...
    'Main Management Dashboard Functions
    ...
    Function IngestOrder()
        ...
        'Fetches Inv_ID and InvOrderQty from InventoryOrderLine
        ...
        'Updates the quantity of each Inventory item ordered in the Inventory table
        ...
        'Updates the InvOrderIngested field to TRUE for the InventoryOrder that was ingested
    ...
    Function FetchOrders(StartDate As String, EndDate As String)
        ...
        'Fetches Order list from CustomerOrder table
        Dim selectQuery As SqlClient.SqlCommand = connection.CreateCommand()
    ...
    Function FetchInventoryDetails()
        ...
        'Fetches Inventory Item Details from the Inventory table
        Dim selectQuery As SqlClient.SqlCommand = connection.CreateCommand()
    ...
    Function FetchInventoryOrderList()
        ...
        'Fetches Inventory Order List from the InventoryOrder table
        Dim selectQuery As SqlClient.SqlCommand = connection.CreateCommand()
    ...
    Function FetchSuppliers()
        ...
        'Fetches Supplier List from the Supplier table
        Dim selectQuery As SqlClient.SqlCommand = connection.CreateCommand()
    ...
    Function EditSupplier()
        'Populates controls on the SuppleirInfo form with the Supplier's information
    ...
    Function FetchMenuItemList()
        ...
        'Fetches Menu Item List from the MenuItem table
        Dim selectQuery As SqlClient.SqlCommand = connection.CreateCommand()
    ...
    Function FetchMenuItemDetails()
        ...
        'Fetches Ingredient Names and Mod Codes for each Ingredient of the selected Item
        Dim selectQuery As SqlClient.SqlCommand = connection.CreateCommand()
        ...
        'Fetches Menu Item Details from the MenuItem table

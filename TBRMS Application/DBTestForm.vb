Public Class DBTestForm
    ...
    Private Sub DBTestForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'dgvCategories.Columns("colCategory").Width = 300

        'dgvCategories.Rows.Add("Burgers")
        'dgvCategories.Rows.Add("Sides")
        'dgvCategories.Rows.Add("Beverages")
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles picOrderSummary.Click
    ...
    Private Sub dgvMenuItems_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvMenuItems.CellContentClick
        Dim index As Integer = e.RowIndex
        Dim selectedRow As DataGridViewRow = dgvMenuItems.Rows(index)
        Dim strCategory As String = selectedRow.Cells(0).Value

        dgvOrderSummary.Rows.Add(strCategory)
    End Sub

    Private Sub btnCheckout_Click(sender As Object, e As EventArgs) Handles btnCheckout.Click
        Dim strOrder(dgvOrderSummary.Rows.Count - 1)() As String

        MessageBox.Show(dgvOrderSummary.Rows.Count)
        ...
        For i As Integer = 0 To dgvOrderSummary.Rows.Count - 1
            ...
            For j As Integer = 0 To 1
                ...
                If j = 0 Then
                    MessageBox.Show("Item: " + strOrder(i)(j))
                Else
                    strOrder(i)(j) = ""
                    MessageBox.Show("Mods: " + strOrder(i)(j))
                End If
            Next
        Next
        ...
        For i As Integer = 0 To strOrder.Length - 1
            Dim insertQuery As String = "INSERT INTO CustomerOrderLine VALUES ((SELECT MenuItem_ID FROM MenuItem WHERE MenuItemName = '"
            For j As Integer = 0 To 1
                Select Case j
                    Case 0
                        insertQuery += strOrder(i)(j) + "'), '"
                    Case 1
                        insertQuery += strOrder(i)(j) + "');"
                End Select
            Next
